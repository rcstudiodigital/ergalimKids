            ...
            return (
              <div key={order.id} className="card p-5">
                ...
                {order.status === 'shipped' && order.trackingCode && (
                  <div className="mt-3 p-3 bg-blue-50 border border-blue-200 rounded-xl text-xs text-blue-700 font-semibold">
                    📦 Seu pedido foi enviado! Rastreie em rastreamento.correios.com.br com o código <span className="font-mono">{order.trackingCode}</span>
                  </div>
                )}
              </div>
            )
