...
export default function AdminDashboard() {
  ...
  return (
    <div className="space-y-6 animate-fadeUp">
      <div>
        <h1 className="text-2xl font-black text-brand-navy">Dashboard Admin</h1>
      ...
      <div className="grid xl:grid-cols-3 gap-6">
        <div className="xl:col-span-2 card">
          <div className="flex items-center justify-between p-5 border-b border-gray-100">
            ...
            <Link to="/admin/orders" className="text-xs text-brand-pink hover:underline font-bold">Ver todos →</Link>
          </div>
              ...
              <tbody>
                {orders.slice(0,5).map(o => (
                  <tr key={o.id} className="border-b border-gray-50 hover:bg-gray-50 transition-colors">
                    <td className="px-5 py-3 font-black text-brand-pink">{o.id}</td>
                    ...
                    <td className="px-5 py-3 text-right font-black text-brand-navy">{formatCurrency(o.total)}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        <div className="card">
          <div className="flex items-center gap-2 p-5 border-b border-gray-100">
            ...
            <h2 className="font-black text-brand-navy">Estoque Baixo</h2>
          </div>
